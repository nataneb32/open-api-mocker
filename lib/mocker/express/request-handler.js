...
const handleRequest = (path, responseHandler, validationErrorFormatter) => (req, res) => {
	...
	if(failedValidations.length)
		return responseHandler(req, res, validationErrorFormatter(failedValidations), 400);
